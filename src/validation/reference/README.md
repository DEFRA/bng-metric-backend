...
Used by the PostGIS baseline validator
(`src/validation/geopackage/postgis/index.js`) to check that an uploaded
baseline's red line boundary lies entirely within England
...
("British Ultra Coarse") precision is sufficient for an `ST_Within` containment
check — it includes Scilly, the Isle of Wight, Holy Island and other offshore
islands.
