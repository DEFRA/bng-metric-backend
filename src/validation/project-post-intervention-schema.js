...
function proposedCommonFields() {
  return {
    ...
    standardTimeToTargetCondition: Joi.string()
      .allow(null, '')
      .description(
        'Statutory time-to-target years (text) from bng-metric-engine before advance/delay; set for Created and Enhanced area features.'
      ),
    difficulty: Joi.string()
      .allow(null, '')
      .description(
        'Difficulty band label (e.g. Low, Medium, High) from habitat-area-difficulty.json; set for Created and Enhanced area features.'
      ),
