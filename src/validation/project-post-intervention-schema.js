...
function proposedCommonFields() {
  return {
    ...
    standardTimeToTargetCondition: Joi.string()
      .allow(null, '')
      .description(
        'Statutory time-to-target years (text) from bng-metric-engine before advance/delay; set for Enhanced area and hedgerow features.'
      ),
    difficulty: Joi.string()
      .allow(null, '')
      .description(
        'Difficulty band label (e.g. Low, Medium, High) from the relevant difficulty reference data; set for Enhanced area and hedgerow features.'
      ),
