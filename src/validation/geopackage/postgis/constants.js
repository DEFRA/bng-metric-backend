// Tolerance / threshold constants shared by the PostGIS geometry checks and
// the lineage derivation. Extracted from postgis/index.js so both can use the
// same numbers — a lineage overlay computed on a different grid size to the
// validation overlay would disagree with it at the sliver boundary.
//
// These are static JS values, not user input, so direct interpolation into SQL
// is safe and keeps the queries self-documenting.
