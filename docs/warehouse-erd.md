...
**17 tables**, mapping 380 schema fields.
...
One row per imported document per project: the GeoPackage upload that produced it. 58 column(s) mapped from the JSON document.
...
| `vertical_areas_ref`                                        | `text`        |     | `baseline.verticalAreas[].ref`<br>`postIntervention.verticalAreas[].ref`                             |                                                                    |
| `vertical_areas_type`                                       | `text`        |     | `baseline.verticalAreas[].type`                                                                      |                                                                    |
| `vertical_areas_broad_type`                                 | `text`        |     | `baseline.verticalAreas[].broadType`                                                                 |                                                                    |
| `vertical_areas_distinctiveness`                            | `text`        |     | `baseline.verticalAreas[].distinctiveness`                                                           |                                                                    |
| `vertical_areas_distinctiveness_score`                      | `numeric`     |     | `baseline.verticalAreas[].distinctivenessScore`                                                      |                                                                    |
| `vertical_areas_condition`                                  | `text`        |     | `baseline.verticalAreas[].condition`                                                                 |                                                                    |
| `vertical_areas_condition_score`                            | `numeric`     |     | `baseline.verticalAreas[].conditionScore`                                                            |                                                                    |
| `vertical_areas_strategic_significance`                     | `text`        |     | `baseline.verticalAreas[].strategicSignificance`                                                     |                                                                    |
| `vertical_areas_retention_category`                         | `text`        |     | `baseline.verticalAreas[].retentionCategory`<br>`postIntervention.verticalAreas[].retentionCategory` |                                                                    |
| `vertical_areas_status`                                     | `text`        |     | `baseline.verticalAreas[].status`<br>`postIntervention.verticalAreas[].status`                       |                                                                    |
| `vertical_areas_units`                                      | `numeric`     |     | `baseline.verticalAreas[].units`<br>`postIntervention.verticalAreas[].units`                         |                                                                    |
| `vertical_areas_site_name`                                  | `text`        |     | `baseline.verticalAreas[].siteName`                                                                  |                                                                    |
| `vertical_areas_survey_date`                                | `text`        |     | `baseline.verticalAreas[].surveyDate`                                                                |                                                                    |
| `vertical_areas_survey_details`                             | `text`        |     | `baseline.verticalAreas[].surveyDetails`                                                             |                                                                    |
| `vertical_areas_comment`                                    | `text`        |     | `baseline.verticalAreas[].comment`                                                                   |                                                                    |
| `vertical_areas_mapped_by`                                  | `text`        |     | `baseline.verticalAreas[].mappedBy`                                                                  |                                                                    |
| `vertical_areas_company`                                    | `text`        |     | `baseline.verticalAreas[].company`                                                                   |                                                                    |
| `vertical_areas_base_map`                                   | `text`        |     | `baseline.verticalAreas[].baseMap`                                                                   |                                                                    |
| `vertical_areas_location`                                   | `text`        |     | `baseline.verticalAreas[].location`                                                                  |                                                                    |
| `vertical_areas_spatial_risk_category`                      | `text`        |     | `baseline.verticalAreas[].spatialRiskCategory`                                                       |                                                                    |
| `vertical_areas_habitat_created_in_advance_years`           | `text`        |     | `baseline.verticalAreas[].habitatCreatedInAdvanceYears`                                              |                                                                    |
| `vertical_areas_delay_in_starting_habitat_creation_years`   | `text`        |     | `baseline.verticalAreas[].delayInStartingHabitatCreationYears`                                       |                                                                    |
| `vertical_areas_raw_distinctiveness`                        | `text`        |     | `baseline.verticalAreas[].rawDistinctiveness`                                                        |                                                                    |
| `vertical_areas_feature_id`                                 | `uuid`        |     | `baseline.verticalAreas[].featureId`<br>`postIntervention.verticalAreas[].featureId`                 |                                                                    |
| `vertical_areas_area`                                       | `numeric`     |     | `baseline.verticalAreas[].area`<br>`postIntervention.verticalAreas[].area`                           |                                                                    |
| `vertical_areas_size_square_metres`                         | `numeric`     |     | `baseline.verticalAreas[].sizeSquareMetres`<br>`postIntervention.verticalAreas[].sizeSquareMetres`   |                                                                    |
| `vertical_areas_properties`                                 | `jsonb`       |     | `baseline.verticalAreas[].properties`<br>`postIntervention.verticalAreas[].properties`               | verbatim GeoPackage attribute columns                              |
| `vertical_areas_baseline_type`                              | `text`        |     | `postIntervention.verticalAreas[].baseline.type`                                                     |                                                                    |
| `vertical_areas_baseline_broad_type`                        | `text`        |     | `postIntervention.verticalAreas[].baseline.broadType`                                                |                                                                    |
| `vertical_areas_baseline_condition`                         | `text`        |     | `postIntervention.verticalAreas[].baseline.condition`                                                |                                                                    |
| `vertical_areas_baseline_condition_score`                   | `numeric`     |     | `postIntervention.verticalAreas[].baseline.conditionScore`                                           |                                                                    |
| `vertical_areas_baseline_distinctiveness`                   | `text`        |     | `postIntervention.verticalAreas[].baseline.distinctiveness`                                          |                                                                    |
| `vertical_areas_baseline_distinctiveness_score`             | `numeric`     |     | `postIntervention.verticalAreas[].baseline.distinctivenessScore`                                     |                                                                    |
| `vertical_areas_baseline_strategic_significance`            | `text`        |     | `postIntervention.verticalAreas[].baseline.strategicSignificance`                                    |                                                                    |
| `vertical_areas_proposed_type`                              | `text`        |     | `postIntervention.verticalAreas[].proposed.type`                                                     |                                                                    |
| `vertical_areas_proposed_broad_type`                        | `text`        |     | `postIntervention.verticalAreas[].proposed.broadType`                                                |                                                                    |
| `vertical_areas_proposed_condition`                         | `text`        |     | `postIntervention.verticalAreas[].proposed.condition`                                                |                                                                    |
| `vertical_areas_proposed_condition_score`                   | `numeric`     |     | `postIntervention.verticalAreas[].proposed.conditionScore`                                           |                                                                    |
| `vertical_areas_proposed_distinctiveness`                   | `text`        |     | `postIntervention.verticalAreas[].proposed.distinctiveness`                                          |                                                                    |
| `vertical_areas_proposed_distinctiveness_score`             | `numeric`     |     | `postIntervention.verticalAreas[].proposed.distinctivenessScore`                                     |                                                                    |
| `vertical_areas_proposed_advance_years`                     | `numeric`     |     | `postIntervention.verticalAreas[].proposed.advanceYears`                                             |                                                                    |
| `vertical_areas_proposed_delay_years`                       | `numeric`     |     | `postIntervention.verticalAreas[].proposed.delayYears`                                               |                                                                    |
| `vertical_areas_proposed_time_multiplier`                   | `numeric`     |     | `postIntervention.verticalAreas[].proposed.timeMultiplier`                                           |                                                                    |
| `vertical_areas_proposed_difficulty_multiplier`             | `numeric`     |     | `postIntervention.verticalAreas[].proposed.difficultyMultiplier`                                     |                                                                    |
| `vertical_areas_proposed_standard_time_to_target_condition` | `text`        |     | `postIntervention.verticalAreas[].proposed.standardTimeToTargetCondition`                            |                                                                    |
| `vertical_areas_proposed_difficulty`                        | `text`        |     | `postIntervention.verticalAreas[].proposed.difficulty`                                               |                                                                    |
| `vertical_areas_proposed_advance_or_delay`                  | `text`        |     | `postIntervention.verticalAreas[].proposed.advanceOrDelay`                                           |                                                                    |
| `vertical_areas_proposed_final_time_to_target_condition`    | `text`        |     | `postIntervention.verticalAreas[].proposed.finalTimeToTargetCondition`                               |                                                                    |
| `vertical_areas_proposed_strategic_significance`            | `text`        |     | `postIntervention.verticalAreas[].proposed.strategicSignificance`                                    |                                                                    |
| `removed_habitats_type`                                     | `text`        |     | `postIntervention.removedHabitats[].type`                                                            |                                                                    |
| `removed_habitats_parent_ref`                               | `text`        |     | `postIntervention.removedHabitats[].parentRef`                                                       |                                                                    |
| `removed_habitats_measure`                                  | `text`        |     | `postIntervention.removedHabitats[].measure`                                                         |                                                                    |
| `removed_habitats_baseline_size`                            | `numeric`     |     | `postIntervention.removedHabitats[].baselineSize`                                                    |                                                                    |
| `removed_habitats_removed_size`                             | `numeric`     |     | `postIntervention.removedHabitats[].removedSize`                                                     |                                                                    |

### `feature_set_units`

Biodiversity unit totals for one document, summed across its features. 14 column(s) mapped from the JSON document.
...
| `vertical_areas_total`                    | `numeric` |     | `baseline.units.verticalAreasTotal`<br>`postIntervention.units.verticalAreasTotal`                                   |                                   |
